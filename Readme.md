...
![Main interface with form filled](docs/screenshots/emptystate.png)
*Main interface showing the empty page.*

![Main interface with form filled](docs/screenshots/formfilled.png)
*Main interface showing airport selection and layover configuration.*

![Generated layover plan](docs/screenshots/plangenerated.png)
*Layover plan generated by GPT-4o with time breakdown and recommendations.*

![Downloaded PDF report](docs/screenshots/pdfreport.png)
*PDF report exported from the application.*

---
## Demo Video

A short demo video showing the application in action is available at:
[Watch the demo](https://1drv.ms/v/c/a93575a9fcba3e6c/IQBF3BKB30zyQJcyRcV6gf7fAfMe_kNAxfiuBQEvQQvMbsQ?e=xl4sYL)
## Technical Decisions
